...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <h4 class="text-center text-secondary" title="Fundación Universitaria Seminario Teológico Bautista Internacional"><b>Fundación Universitaria Seminario Teológico Bautista Internacional</b></h4>
    </div>
    <!-- /.content-header -->
    <!-- Main content -->
