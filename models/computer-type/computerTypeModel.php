        ...
        public function insertComputerType(){
            if (isset($_POST['insert_computer_type'])){
                ...
                if(mysqli_num_rows($result_computer_type)>0){
                    ...
                    $sql = "INSERT INTO tbltipo_computador(tip_com_descripcion,tip_com_fecha_registro,tblestado_general_est_gen_id) VALUES ('$this->tipo_computador_descripcion','$this->tipo_computador_fecha_registro',$this->estado)";
                    //mysqli_query = Realiza una consulta a la base de datos
                    $result = mysqli_query($this->conection,$sql);
                    if ($result){
                        return $result;
