<?php
    ...
    class FamilyEmployee extends Connection {
        ...
        private $fam_emp_numero_documento_empleado;
        ...
        private $fam_emp_parentesco_familiar1;
        ...
        private $fam_emp_parentesco_familiar2;
        ...
        private $fam_emp_parentesco_familiar3;
        ...
        private $fam_emp_parentesco_familiar4;
        ...
        private $fam_emp_parentesco_familiar5;
        ...
        public function insertFamilyEmployee() {
            if (isset($_POST['insert_family_employee'])){
                ...
                if (empty($_POST['ins-fam-emp-doc'])) {
                    $this->fam_emp_numero_documento_empleado   = '0';       
                }
                ...
                $this->fam_emp_parentesco_familiar1            = $_POST['ins-fam-emp-par-fau'];
                if (empty($_POST['ins-fam-emp-par-fau'])) {
                    $this->fam_emp_parentesco_familiar1        = 'NULL';       
                }
                ...
                $this->fam_emp_parentesco_familiar2            = $_POST['ins-fam-emp-par-fad'];
                if (empty($_POST['ins-fam-emp-par-fad'])) {
                    $this->fam_emp_parentesco_familiar2        = 'NULL';       
                }
                ...
                $this->fam_emp_parentesco_familiar3            = $_POST['ins-fam-emp-par-fat'];
                if (empty($_POST['ins-fam-emp-par-fat'])) {
                    $this->fam_emp_parentesco_familiar3        = 'NULL';       
                }
                ...
                $this->fam_emp_parentesco_familiar4            = $_POST['ins-fam-emp-par-fac'];
                if (empty($_POST['ins-fam-emp-par-fac'])) {
                    $this->fam_emp_parentesco_familiar4        = 'NULL';       
                }
                ...
                $this->fam_emp_parentesco_familiar5            = $_POST['ins-fam-emp-par-fai'];
                if (empty($_POST['ins-fam-emp-par-fai'])) {
                    $this->fam_emp_parentesco_familiar5        = 'NULL';       
                }
                $this->tblestado_general_est_gen_id            = 1;
                
                $document = "SELECT fam_emp_numero_documento_empleado FROM tblfamilia_empleado WHERE fam_emp_numero_documento_empleado = '$this->fam_emp_numero_documento_empleado'";
                //mysqli_query = Realiza una consulta a la base de datos
                ...
                if(mysqli_num_rows($result_document)>0) {
                    echo "<script>alert('¡El número de documento ya está registrado!')</script>";
                }elseif (mysqli_num_rows($result_employee)>0) {
                    echo "<script>alert('¡El nombre del empleado ya está registrado!')</script>";
                }else {
                    $sql = "INSERT INTO tblfamilia_empleado(fam_emp_nombre_completo_empleado,fam_emp_numero_documento_empleado,fam_emp_tipo_documento_familiar1,fam_emp_numero_documento_familiar1,fam_emp_primer_nombre_familiar1,fam_emp_segundo_nombre_familiar1,fam_emp_primer_apellido_familiar1,fam_emp_segundo_apellido_familiar1,fam_emp_parentesco_familiar1,fam_emp_tipo_documento_familiar2,fam_emp_numero_documento_familiar2,fam_emp_primer_nombre_familiar2,fam_emp_segundo_nombre_familiar2,fam_emp_primer_apellido_familiar2,fam_emp_segundo_apellido_familiar2,fam_emp_parentesco_familiar2,fam_emp_tipo_documento_familiar3,fam_emp_numero_documento_familiar3,fam_emp_primer_nombre_familiar3,fam_emp_segundo_nombre_familiar3,fam_emp_primer_apellido_familiar3,fam_emp_segundo_apellido_familiar3,fam_emp_parentesco_familiar3,fam_emp_tipo_documento_familiar4,fam_emp_numero_documento_familiar4,fam_emp_primer_nombre_familiar4,fam_emp_segundo_nombre_familiar4,fam_emp_primer_apellido_familiar4,fam_emp_segundo_apellido_familiar4,fam_emp_parentesco_familiar4,fam_emp_tipo_documento_familiar5,fam_emp_numero_documento_familiar5,fam_emp_primer_nombre_familiar5,fam_emp_segundo_nombre_familiar5,fam_emp_primer_apellido_familiar5,fam_emp_segundo_apellido_familiar5,fam_emp_parentesco_familiar5,tblestado_general_est_gen_id,fam_emp_fecha_registro) VALUES ('$this->fam_emp_nombre_completo_empleado',$this->fam_emp_numero_documento_empleado,'$this->fam_emp_tipo_documento_familiar1',$this->fam_emp_numero_documento_familiar1,'$this->fam_emp_primer_nombre_familiar1','$this->fam_emp_segundo_nombre_familiar1','$this->fam_emp_primer_apellido_familiar1','$this->fam_emp_segundo_apellido_familiar1','$this->fam_emp_parentesco_familiar1','$this->fam_emp_tipo_documento_familiar2',$this->fam_emp_numero_documento_familiar2,'$this->fam_emp_primer_nombre_familiar2','$this->fam_emp_segundo_nombre_familiar2','$this->fam_emp_primer_apellido_familiar2','$this->fam_emp_segundo_apellido_familiar2','$this->fam_emp_parentesco_familiar2','$this->fam_emp_tipo_documento_familiar3',$this->fam_emp_numero_documento_familiar3,'$this->fam_emp_primer_nombre_familiar3','$this->fam_emp_segundo_nombre_familiar3','$this->fam_emp_primer_apellido_familiar3','$this->fam_emp_segundo_apellido_familiar3','$this->fam_emp_parentesco_familiar3','$this->fam_emp_tipo_documento_familiar4',$this->fam_emp_numero_documento_familiar4,'$this->fam_emp_primer_nombre_familiar4','$this->fam_emp_segundo_nombre_familiar4','$this->fam_emp_primer_apellido_familiar4','$this->fam_emp_segundo_apellido_familiar4','$this->fam_emp_parentesco_familiar4','$this->fam_emp_tipo_documento_familiar5',$this->fam_emp_numero_documento_familiar5,'$this->fam_emp_primer_nombre_familiar5','$this->fam_emp_segundo_nombre_familiar5','$this->fam_emp_primer_apellido_familiar5','$this->fam_emp_segundo_apellido_familiar5','$this->fam_emp_parentesco_familiar5',$this->tblestado_general_est_gen_id,NOW())";
                    //mysqli_query = Realiza una consulta a la base de datos
                    $result = mysqli_query($this->conection,$sql);
                    if ($result) {
                        return $result;
        ...
        public function updateFamilyEmployee() {
            ...
            if(isset($_POST['update_family_employee'])){
                ...
                $this->fam_emp_numero_documento_empleado  = $_POST['upd-fam-emp-doc'];
                if (empty($_POST['upd-fam-emp-doc'])) {
                    $this->fam_emp_numero_documento_empleado  = '0';       
                }
                ...
                $this->fam_emp_parentesco_familiar1       = $_POST['upd-fam-emp-par-fau'];
                if (empty($_POST['upd-fam-emp-par-fau'])) {
                    $this->fam_emp_parentesco_familiar1   = 'NULL';       
                }
                ...
                $this->fam_emp_parentesco_familiar2            = $_POST['upd-fam-emp-par-fad'];
                if (empty($_POST['upd-fam-emp-par-fad'])) {
                    $this->fam_emp_parentesco_familiar2        = 'NULL';       
                }
                ...
                $this->fam_emp_parentesco_familiar3            = $_POST['upd-fam-emp-par-fat'];
                if (empty($_POST['upd-fam-emp-par-fat'])) {
                    $this->fam_emp_parentesco_familiar3        = 'NULL';       
                }
                ...
                $this->fam_emp_parentesco_familiar4            = $_POST['upd-fam-emp-par-fac'];
                if (empty($_POST['upd-fam-emp-par-fac'])) {
                    $this->fam_emp_parentesco_familiar4        = 'NULL';       
                }
                ...
                $this->fam_emp_parentesco_familiar5            = $_POST['upd-fam-emp-par-fai'];
                if (empty($_POST['upd-fam-emp-par-fai'])) {
                    $this->fam_emp_parentesco_familiar5        = 'NULL';       
                }
                // En una variable almaceno el sql con los datos que capturamos
                $sql = "UPDATE tblfamilia_empleado SET fam_emp_numero_documento_empleado = $this->fam_emp_numero_documento_empleado,fam_emp_nombre_completo_empleado = '$this->fam_emp_nombre_completo_empleado',fam_emp_tipo_documento_familiar1 = '$this->fam_emp_tipo_documento_familiar1', fam_emp_numero_documento_familiar1 = $this->fam_emp_numero_documento_familiar1, fam_emp_primer_nombre_familiar1 = '$this->fam_emp_primer_nombre_familiar1', fam_emp_segundo_nombre_familiar1 = '$this->fam_emp_segundo_nombre_familiar1', fam_emp_primer_apellido_familiar1 = '$this->fam_emp_primer_apellido_familiar1', fam_emp_segundo_apellido_familiar1 = '$this->fam_emp_segundo_apellido_familiar1',fam_emp_parentesco_familiar1 = '$this->fam_emp_parentesco_familiar1',fam_emp_tipo_documento_familiar2 = '$this->fam_emp_tipo_documento_familiar2',fam_emp_numero_documento_familiar2 = $this->fam_emp_numero_documento_familiar2, fam_emp_primer_nombre_familiar2 = '$this->fam_emp_primer_nombre_familiar2', fam_emp_segundo_nombre_familiar2 = '$this->fam_emp_segundo_nombre_familiar2',fam_emp_primer_apellido_familiar2 = '$this->fam_emp_primer_apellido_familiar2',fam_emp_segundo_apellido_familiar2 = '$this->fam_emp_segundo_apellido_familiar2', fam_emp_parentesco_familiar2 = '$this->fam_emp_parentesco_familiar2',fam_emp_tipo_documento_familiar3 = '$this->fam_emp_tipo_documento_familiar3',fam_emp_numero_documento_familiar3 = $this->fam_emp_numero_documento_familiar3,fam_emp_primer_nombre_familiar3 = '$this->fam_emp_primer_nombre_familiar3', fam_emp_segundo_nombre_familiar3 = '$this->fam_emp_segundo_nombre_familiar3',fam_emp_primer_apellido_familiar3 = '$this->fam_emp_primer_apellido_familiar3', fam_emp_segundo_apellido_familiar3 = '$this->fam_emp_segundo_apellido_familiar3',fam_emp_parentesco_familiar3 = '$this->fam_emp_parentesco_familiar3',fam_emp_tipo_documento_familiar4 = '$this->fam_emp_tipo_documento_familiar4',fam_emp_numero_documento_familiar4 = $this->fam_emp_numero_documento_familiar4, fam_emp_primer_nombre_familiar4 = '$this->fam_emp_primer_nombre_familiar4', fam_emp_segundo_nombre_familiar4 = '$this->fam_emp_segundo_nombre_familiar4',fam_emp_primer_apellido_familiar4 = '$this->fam_emp_primer_apellido_familiar4',fam_emp_segundo_apellido_familiar4 = '$this->fam_emp_segundo_apellido_familiar4',fam_emp_parentesco_familiar4 = '$this->fam_emp_parentesco_familiar4',fam_emp_tipo_documento_familiar5 = '$this->fam_emp_tipo_documento_familiar5',fam_emp_numero_documento_familiar5 = $this->fam_emp_numero_documento_familiar5, fam_emp_primer_nombre_familiar5 = '$this->fam_emp_primer_nombre_familiar5', fam_emp_segundo_nombre_familiar5 = '$this->fam_emp_segundo_nombre_familiar5',fam_emp_primer_apellido_familiar5 = '$this->fam_emp_primer_apellido_familiar5', fam_emp_segundo_apellido_familiar5 = '$this->fam_emp_segundo_apellido_familiar5',fam_emp_parentesco_familiar5 = '$this->fam_emp_parentesco_familiar5' WHERE fam_emp_id = $this->fam_emp_id";
                //mysqli_query = Realiza una consulta a la base de datos
