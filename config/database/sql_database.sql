...
CREATE TABLE tbleps(
    ...
    eps_telefono_eps             VARCHAR(40) NULL,
    eps_celular_eps              INT(15) UNSIGNED NULL,
    eps_ciudad                   VARCHAR(70) NOT NULL,
    eps_direccion                VARCHAR(70) NOT NULL,
    eps_nombre_encargado         VARCHAR(70) NULL,
    eps_correo_encargado         VARCHAR(70) NULL,
    eps_telefono_encargado       VARCHAR(40) NULL,
    eps_celular_encargado        INT(15) UNSIGNED NULL,
    tblestado_general_est_gen_id INT(30) UNSIGNED NOT NULL,
...
CREATE TABLE tblarl(
    ...
    arl_telefono_arl             VARCHAR(40) NULL,
    arl_celular_arl              INT(15) UNSIGNED NULL,
    arl_ciudad                   VARCHAR(70) NOT NULL,
    arl_direccion                VARCHAR(70) NOT NULL,
    arl_nombre_encargado         VARCHAR(70) NULL,
    arl_correo_encargado         VARCHAR(70) NULL,
    arl_telefono_encargado       VARCHAR(40) NULL,
    arl_celular_encargado        INT(15) UNSIGNED NULL,
    tblestado_general_est_gen_id INT(30) UNSIGNED NOT NULL,
...
CREATE TABLE tblcaja_compensacion(
    ...
    caj_com_telefono_cc          VARCHAR(40) NULL,
    caj_com_celular_cc           INT(15) UNSIGNED NULL,
    caj_com_ciudad               VARCHAR(70) NOT NULL,
    caj_com_direccion            VARCHAR(70) NOT NULL,
    caj_com_nombre_encargado     VARCHAR(70) NULL,
    caj_com_correo_encargado     VARCHAR(70) NULL,
    caj_com_telefono_encargado   VARCHAR(40) NULL,
    caj_com_celular_encargado    INT(15) UNSIGNED NULL,
    tblestado_general_est_gen_id INT(30) UNSIGNED NOT NULL,
...
CREATE TABLE tblfondo_pension(
    ...
    fon_pen_telefono_fp          VARCHAR(40) NULL,
    fon_pen_celular_fp           INT(15) UNSIGNED NULL,
    fon_pen_ciudad               VARCHAR(70) NOT NULL,
    fon_pen_direccion            VARCHAR(70) NOT NULL,
    fon_pen_nombre_encargado     VARCHAR(70) NULL,
    fon_pen_correo_encargado     VARCHAR(70) NULL,
    fon_pen_telefono_encargado   VARCHAR(40) NULL,
    fon_pen_celular_encargado    INT(15) UNSIGNED NULL,
    tblestado_general_est_gen_id INT(30) UNSIGNED NOT NULL,
...
CREATE TABLE tblfamilia_empleado(
    ...
    fam_emp_parentesco_familiar1       VARCHAR(70) NULL,
    ...
    fam_emp_parentesco_familiar2       VARCHAR(70) NULL,
    ...
    fam_emp_parentesco_familiar3       VARCHAR(70) NULL,
    ...
    fam_emp_parentesco_familiar4       VARCHAR(70) NULL,
    ...
    fam_emp_parentesco_familiar5       VARCHAR(70) NULL,
    tblestado_general_est_gen_id       INT(30) UNSIGNED NOT NULL,
...
CREATE TABLE tblproveedor(
    ...
    pro_telefono_proveedor       VARCHAR(40) NULL,
    pro_celular_proveedor        INT(15) UNSIGNED NULL,
    pro_ciudad                   VARCHAR(70) NOT NULL,
    pro_direccion                VARCHAR(70) NOT NULL,
    pro_nombre_encargado         VARCHAR(70) NULL,
    pro_correo_encargado         VARCHAR(70) NULL,
    pro_telefono_encargado       VARCHAR(40) NULL,
    pro_celular_encargado        INT(15) UNSIGNED NULL,
    tblestado_general_est_gen_id INT(30) UNSIGNED NOT NULL,
...
CREATE TABLE tblhistoria_laboral( 
    his_lab_id                    INT(30) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    his_lab_prorroga              VARCHAR(100) NULL,
...
-- Foranea Tabla Historial Laboral

ALTER TABLE     tblhistoria_laboral 
ADD FOREIGN KEY (tblempleado_emp_id) 
REFERENCES      tblempleado(emp_id);
...
INSERT INTO `tblproveedor` (`pro_id`, `pro_nit`, `pro_razon_social`, `pro_producto_servicio`, `pro_correo_proveedor`, `pro_telefono_proveedor`, `pro_celular_proveedor`, `pro_ciudad`, `pro_direccion`, `pro_nombre_encargado`, `pro_telefono_encargado`, `pro_celular_encargado`, `pro_correo_encargado`, `tblestado_general_est_gen_id`, `pro_fecha_registro`) VALUES 
(1, '860045752-4', 'AUROS COPIAS S.A.S', 'Asesoria y Tecnologia', 'exitosanfernando@auros.com.co', '(601) 348 0727', '3102127960', 'Cali', 'Calle 5 # 38D-35 Exito San Fernando Local 124A', 'Fabian Espinosa Suarez', '0', '3138282325', 'fabian.espinosa@aurosnet.com', '1', '2021-10-04');
